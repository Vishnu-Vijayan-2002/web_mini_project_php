...
<div class="hero-donation-container">
    <!-- Unified Donation Card (Moved to Top Left) -->
    ...
    <div class="donation-buttons">
        <button onclick="window.location.href='donate_meals.php'" class="btn btn-success">Donate Meals</button>
        <button onclick="window.location.href='donate_cash.php'" class="btn btn-warning">Donate Cash</button>
        <button onclick="window.location.href='donation_request.php'" class="btn btn-danger">Request Donation</button>
    </div>
</div>


    <!-- Hero Section (Now Positioned to the Right) -->
...
<!-- Quotes Section (Now Below Donation Card) -->
...
<script>
  window.onload = function () {
    ...
    const donateMealsBtn = document.querySelector(".btn-success");
    const donateCashBtn = document.querySelector(".btn-warning");
    const requestDonationBtn = document.querySelector(".btn-danger");
